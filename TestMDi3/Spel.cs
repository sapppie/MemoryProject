...
namespace TestMDi3
{
    public partial class Spel : Form
    {
        ...
        public object arrayimage { get; private set; }
        ...
        public void LoadOldSP()
        {
            ...
            doc.Load("SPSave.xml");
            singlenaam = Convert.ToString(doc.SelectSingleNode("settings/ints/singlenaam").InnerText);
            length = Convert.ToInt32(doc.SelectSingleNode("settings/ints/length").InnerText);
            width = Convert.ToInt32(doc.SelectSingleNode("settings/ints/width").InnerText);
            selectedtheme = Convert.ToString(doc.SelectSingleNode("settings/ints/selectedtheme").InnerText);
            Player1_score = Convert.ToInt16(doc.SelectSingleNode("settings/ints/score").InnerText);
            Label_Player1score.Text = Convert.ToString(Player1_score);
        }
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
                ...
                writer.WriteElementString("arrayimage", Convert.ToString(arrayimage));
